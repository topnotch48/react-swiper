...
/***/ function(module, exports, __webpack_require__) {
	...
	var _swiperMin = __webpack_require__(8);
	...
	var SwiperComponent = _react2.default.createClass({
	    displayName: 'SwiperComponent',

	    propTypes: {
	        swiperConfig: _react2.default.PropTypes.object,
	        containerClass: _react2.default.PropTypes.string,
	        onSwiperMount: _react2.default.PropTypes.func,
	        onSwiperUnmount: _react2.default.PropTypes.func
	    },
	    ...
	    formatChildren: function formatChildren(children, config) {
	        return _react2.default.Children.map(children, function (child, index) {
	            return _react2.default.createElement(
	                'div',
	                { className: config.slideClass, key: index },
	                child
	            );
	        });
	    },
	    createSwiper: function createSwiper() {
	        var config = (0, _merge2.default)(defaultSwiperConfig, this.props.swiperConfig);
	        var pagination = config.hasOwnProperty('pagination') ? null : _react2.default.createElement('div', { className: 'swiper-pagination' });
	        var btnNext = config.hasOwnProperty('nextButton') ? null : _react2.default.createElement('div', { className: 'swiper-button-next' });
	        var btnPrev = config.hasOwnProperty('prevButton') ? null : _react2.default.createElement('div', { className: 'swiper-button-prev' });
	        var scrollBar = config.hasOwnProperty('scrollbar') ? null : _react2.default.createElement('div', { className: 'swiper-scrollbar' });
	        var children = this.formatChildren(this.props.children, config);

	        var container = _reactDom2.default.findDOMNode(this.refs.swiperContainer);

	        var content = _react2.default.createElement(
	            'div',
	            { className: this.props.containerClass, ref: 'swiperContainer' },
	        ...
	        container.innerHTML = _server2.default.renderToStaticMarkup(content);

	        return new _swiper2.default(container.children[0], config);
	    },
	    render: function render() {
	        return _react2.default.createElement('div', { ref: 'swiperContainer', className: 'react-swiper-component' });
	    }
	});
